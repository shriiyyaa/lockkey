...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-mono-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[url('data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%2352525b\' fill-opacity=\'0.05\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')]">
        ...
        <div className="geometric-card py-8 px-4 sm:px-10">
          ...
          <div className="mt-8 pt-6 border-t-2 border-mono-200 text-center">
            <p className="font-black text-[10px] text-mono-500 uppercase tracking-[0.15em]">
              NO ACCOUNT DETECTED?{' '}
              <Link to="/signup" className="text-mono-950 underline decoration-2 hover:bg-mono-950 hover:text-ivory transition-all px-1">
                CREATE_IDENTITY
              </Link>
            </p>
          </div>
